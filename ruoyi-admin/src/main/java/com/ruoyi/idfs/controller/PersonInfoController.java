...
/*    @PreAuthorize("@ss.hasPermi('idfs:personInfo:edit')")*/
    ...
    @PutMapping("/updateSecondContact/{peopleId}")
    public AjaxResult updateSecondContactStatusByContact(@PathVariable String peopleId)
    {
        String a = peopleId;
        return toAjax(personInfoService.updateSecondContactStatusByContact(peopleId));
    }
